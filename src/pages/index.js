import "./index.css";
import { enableValidation, settings, toggleButtonState, resetValidation } from "../scripts/validation.js";
...
const profileFormSubmitBtn = editProfileModal.querySelector(".modal__submit-btn");
...
editProfileBtn.addEventListener("click", function () {
  ...
  resetValidation(editProfileForm, [nameProfileInput, editModalDescriptionInput], settings);
  toggleButtonState([nameProfileInput, editModalDescriptionInput], profileFormSubmitBtn, settings);
...
function handleEditProfileSubmit(evt) {
  evt.preventDefault();
  api
  .editUserInfo({ name: nameProfileInput.value, about: editModalDescriptionInput.value })
  .then((data) => {
...
avatarEditBtn.addEventListener("click", function () {
  ...
  toggleButtonState([avatarLinkInput], avatarForm.querySelector(".modal__submit-btn"), settings);
